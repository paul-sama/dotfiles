...
//    const DEFAULT_HINTCHARS = "HJKLASDFGYUIOPQWERTNMZXCVB";
    const DEFAULT_HINTCHARS = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
...
//    let showCase = function(str) str.toUpperCase();
    let inputCase = function(str) str.toLowerCase();
    let inputRegex = /[a-z]/;
    let showCase = function(str) str.toLowerCase();
//    let getStartCount = function() 0;
    let getStartCount = function() -1;
